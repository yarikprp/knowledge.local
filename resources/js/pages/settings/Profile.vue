    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                <HeadingSmall title="Информация" description="Обновите свое имя и адрес электронной почты" />

                <form @submit.prevent="submit" class="space-y-6">
                    <div class="grid gap-2">
                        <Label for="name">ФИО</Label>
                        <Input id="name" class="mt-1 block w-full" v-model="form.name" required autocomplete="name" placeholder="Попов Ярослав Юрьевич" />
                    ...
                    <div v-if="mustVerifyEmail && !user.email_verified_at">
                        <p class="-mt-4 text-sm text-muted-foreground">
                            Ваш адрес электронной почты не проверен.
                            <Link
